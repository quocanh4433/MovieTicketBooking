            ...
            return <div className="multipleRow__wrapper" key={index}>
                <div className="multipleRow__item">
                    <div className="multipleRow__item-bg">
                        <NavLink to={`/detail/${film.maPhim}`} className="btn-booking">ĐẶT VÉ</NavLink>
                        <div className="btn-trailer" onClick={() => {
                            setModal(true)
                            setTrailer(film.trailer)
                        }} >
                            <svg viewBox="0 0 295 295" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M109.699 78.969C107.823 80.036 106.664 82.028 106.664 84.185V215.859C106.664 219.173 109.351 221.859 112.664 221.859C115.977 221.859 118.664 219.173 118.664 215.859V94.74L207.497 147.623L142.173 189.71C139.388 191.505 138.584 195.218 140.379 198.003C142.175 200.789 145.887 201.593 148.673 199.797L222.138 152.464C223.884 151.339 224.924 149.391 224.887 147.314C224.85 145.237 223.742 143.327 221.957 142.264L115.733 79.029C113.877 77.926 111.575 77.902 109.699 78.969Z" fill="white" />
                            </svg>
                        </div>
                    </div>
